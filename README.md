...
This project analyses $400B+ of UK import data to identify the largest product categories 
where India holds less than 5% market share — and quantifies the opportunity gap.
...
The UK imports **$400.7B** of goods annually. India supplies only **$12.5B** of that — 
leaving a **$388.2B gap**. The three biggest under-represented categories:
...
**Chendur Murugan** — MSc Business Analytics, University of Exeter
Previously: Software Engineer @ IQVIA (2.7 years)
[LinkedIn](https://linkedin.com/in/yourprofile) | [GitHub](https://github.com/ChendurC)
